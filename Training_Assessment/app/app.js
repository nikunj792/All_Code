...
export default class App extends React.Component{
	...
	render(){
		const arr = ['Organization Name','Organization ID', 'dskjfnkjdsf','Organization Name','Organization ID', 'dskjfnkjdsf','Organization Name','Organization ID', 'dskjfnkjdsf','Organization Name','Organization ID', 'dskjfnkjdsf','Organization Name','Organization ID', 'dskjfnkjdsf'];
		return (
			<div>					
